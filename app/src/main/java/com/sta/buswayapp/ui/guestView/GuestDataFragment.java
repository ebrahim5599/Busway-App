        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty()) {
                    ...
                    GuestData guestData = new GuestData(name, phone, companyName, projectName, position);
                    editor.putString(ConstantNames.GUEST_NAME, guestData.getGuestName());
                    editor.putString(ConstantNames.GUEST_PHONE_NUMBER, guestData.getGuestPhoneNumber());
                    editor.putString(ConstantNames.GUEST_COMPANY, guestData.getGuestCompanyName());
                    editor.putString(ConstantNames.GUEST_COMPANY_PROJECT, guestData.getGuestCompanyProjectName());
                    editor.putString(ConstantNames.GUEST_POSITION, guestData.getGuestPosition());
